...
def _prepare_download(
    repo_id: str, output_dir: Path, repo_type: str, source_name: str
) -> Path:
...
def download_from_huggingface(
    ...
    final_output_dir = _prepare_download(
        repo_id, output_dir, repo_type, "HuggingFace Hub"
    )
...
def download_from_modelscope(
    ...
    final_output_dir = _prepare_download(
        repo_id, output_dir, repo_type, "ModelScope")
...
Note: For private repositories, set HF_TOKEN environment variable:
  export HF_TOKEN=your_token_here
    ...
    if args.output_dir == "":
        args.output_dir = f"/share/project/fengyupu/{args.repo_type}"
